...
void BlockEntity::AddBlockFaces(Chunk* chunk)
{
	if (m_BlockId == BlockIds::Air) return;
#ifndef SERVER_BUILD
	...
	//	chunk->m_ChunkMesh->AddBlockFace((ChunkBlock*)this, blockType->faces[Directions::East]);
...
{
	return nullptr;// TODO: World::GetChunkAt(m_ChunkPosition);
}
